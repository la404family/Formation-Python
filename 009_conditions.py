...
# Exercice 2 : Simulateur de feux tricolores
# def feu_tricolore():
#     couleur = input("Couleur du feu (rouge/orange/vert) : ").lower()
#     
#     if couleur == "rouge":
#         print("🔴 ARRÊT obligatoire")
#     elif couleur == "orange":
#         print("🟠 ATTENTION - Préparez-vous à vous arrêter")
#     elif couleur == "vert":
#         print("🟢 PASSAGE autorisé")
#     else:
#         print("❓ Couleur non reconnue")

# Exercice 3 : Système de rabais
# def calculer_rabais():
#     montant = float(input("Montant des achats : "))
#     age = int(input("Âge : "))
#     etudiant = input("Êtes-vous étudiant ? (oui/non) : ").lower() == "oui"
#     
#     rabais = 0
#     
#     if age >= 65:
...
#     
#     if rabais > 0:
#         montant_final = montant * (1 - rabais/100)
#         print(f"Rabais : {rabais}% - Montant final : {montant_final:.2f}€")
#     else:
#         print(f"Aucun rabais - Montant : {montant:.2f}€")

# Exercice 4 : Vérificateur de triangle
# def verifier_triangle():
...
#         print(f"✅ Triangle {type_triangle} valide")
#     else:
#         print("❌ Triangle invalide")

# Exercice 5 : Calculateur d'année bissextile
